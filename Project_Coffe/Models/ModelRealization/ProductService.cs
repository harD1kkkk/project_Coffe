...
namespace CoffeeShopAPI.Services
{
    public class ProductService : IProductService
    {
        ...
        public async Task<IEnumerable<Product>> SortByLowerPrice(decimal price)
        {
            try
            {
                IEnumerable<Product> products = await _dbContext.Set<Product>()
            ...
            {
                _logger.LogError($"Error fetching products with price lower than '{price}': {ex.Message}");
                throw new Exception("An error occurred while fetching the products.");
            }
        }
        public async Task<IEnumerable<Product>> SortByHigherPrice(decimal price)
        {
            try
            {
                IEnumerable<Product> products = await _dbContext.Set<Product>()
            ...
            {
                _logger.LogError($"Error fetching products with price higher than '{price}': {ex.Message}");
                throw new Exception("An error occurred while fetching the products.");
            }
        }
    }
